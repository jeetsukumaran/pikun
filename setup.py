...
project_init = _read(["src", "pikun", "__init__.py"])
...
setup(
    ...
    package_data={
        ...
        "pikun": [
            ...
            # For files located in 'src/pikun-data/'
            # "../pikun-data/*.json",
    ...
    test_suite = "tests",
    # url="http://pypi.python.org/pypi/pikun",
    url="https://github.com/jeetsukumaran/pikun",
    license="LICENSE",
